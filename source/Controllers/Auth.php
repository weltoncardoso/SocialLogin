    ...
    public function google(): void
    {
        ...
        if ($code && empty($_SESSION["google_auth"])) {
            try {
                ...
                flash("error","Não foi possível logar com o Goocle ");
                $this->router->redirect("web_login");
            }
        }
...
//        REGISTER IF NOT
        ...
        flash(
            "info",
            "Olá {$google_user->getFirstName()},<b>se já tem conta clique em <a title='fazer login' href='{$link}'>FAZER LOGIN</a></b> ou complete seu cadastro");
        $this->router->redirect("web_register");
    }
